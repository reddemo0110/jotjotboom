...
rich-editor-toggle = Rich editor (experimental)
rich-editor-hint = The new cosmic-text editor. Phase 1: same look as before, new engine underneath. Switch back any time.
